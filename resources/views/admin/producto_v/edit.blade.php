                ...
                <div class="card card-info">
                  ...
                  <div class="card-body">
                   ...
                   <div class="form-group">
                      ...
                      <textarea class="form-control ckeditor" name="datos_deinteres" id="datos_de_interes" rows="5">
             ...
             <div class="card card-warning">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                   ...
                   <label for="archivosimagenes">Seleccione sus imágenes</label>
                   ...
                   <div class="description">
                        <ul><br>
                            <li type="square">Número limitado de imágenes.</li>
                            <li type="square">Límite de 3 MB por imagen.</li>
                            <li type="square">Tipos permitidos: jpeg, png, jpg, gif, svg.</li>
                        </ul>
                   </div>
          ...
          <div class="card-body">
           ...
           <div class="row">
                  <div class="col-md-9">
                        ...
                        <a class="btn btn-danger" href="{{ route('cancelar','admin.producto_c.index') }}">Cancelar</a>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <a class="btn btn-outline-success" href="{{ route('cancelar','admin.producto_c.index') }}">Sin más cambios</a>
                            <input :disabled="btn_deshabilitado==1" type="submit" value="Guardar" class="btn btn-primary float-right">
                    </div>
