...
/*********************************
* Pagina tutorial
* https://programacion.net/articulo/buscador_con_autocompletado_mediante_bootstrap_typeahead_1874
* http://twitter.github.io/typeahead.js/
*******************************/
$( document ).ready(function() {
$('input.typeahead').typeahead({
source: function (query, process) {
return $.get("{{url('/api/autocompletar')}}", { query: query }, function (data) {
data = $.parseJSON(data);
return process(data);
});
},
                  ...
                  <div class="card-tools">
                      ...
                      <form>
                        <div class="input-group input-group-sm" style="width:550px;">
                            ...
                            <input id="birds" type="text" name="nombre" class=" typeahead form-control float-right" autocomplete="off" placeholder="Buscar o mostrar todos"
                            >
