...
<div id="apiproducto">
<form action="{{ route('admin.producto_c.store') }}" method="POST" enctype="multipart/form-data" >
    @csrf
           ...
           <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                       ...
                       <input :disabled="btn_deshabilitado==1" type="submit" value="Guardar" class="btn btn-primary">
