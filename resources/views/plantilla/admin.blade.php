...
<div id="apiautocompletar" style="relativa">
    <!-- SEARCH FORM -->
    <form class="form-inline ml-3">
      <div class="input-group input-group-sm">
        <input class="form-control form-control-navbar" autocomplete="off" type="search" placeholder="Search"
        aria-label="Search"

        name="nombre"
        v-model='palabra_abuscar'
        v-on:keyup="autoCompletar"
    ...
    <div class="panel-footer" v-if="resultados.length">
        ...
        <li class="list-group-item" v-for="resultado in resultados">
            <a class="dropdown-item" v-on:click.prevent="palabra_abuscar=resultado.nombre" >
                <span v-html="resultado.negrita"></span>
            </a>
        </li>
    </ul>
</div>
 ...
 <!-- Categorias -->
               <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{ route('admin.categoria_c.index') }}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Listado de Categorías</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{ route('admin.categoria_c.create') }}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
 ...
 <!-- /Categorias -->
  ...
  <li class="nav-item has-treeview">
    ...
    <ul class="nav nav-treeview">
      <li class="nav-item">
        <a href="{{ route('admin.producto_c.index') }}" class="nav-link">
          <i class="far fa-circle nav-icon"></i>
          <p>Listado de Productos</p>
        </a>
      </li>
      <li class="nav-item">
        <a href="{{ route('admin.producto_c.create') }}" class="nav-link">
          <i class="far fa-circle nav-icon"></i>
...
<!-- /Productos -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        @if ( session('datos') )
            <div id="datosb" class="alert alert-dismissible fade show" role="alert">
                {{ session('datos') }}
        ...
        @endif
        @if ( session('cancelar') )
        <div  id="cancelarb" class="alert alert-dismissible fade show" role="alert">
            {{ session('cancelar') }}
            <button type="button" class="close" data-dismiss="alert" aria-label="close">
                <span aria-hidden="true">&times;</span>
            </button>
