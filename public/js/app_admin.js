...
/***/ "./resources/js/admin/apiautocompletar.js":
/*!************************************************!*\
  !*** ./resources/js/admin/apiautocompletar.js ***!
  \************************************************/
/*! no static exports found */
...
var apiautocompletar = new Vue({
  el: '#apiautocompletar',
  data: {
    palabra_abuscar: '',
    //para diferenciar de palabraabuscar en el metodo de api/autocompletarcontroller
    resultados: []
  },
  methods: {
    autoCompletar: function autoCompletar() {
      var _this = this;
      ...
      if (this.palabra_abuscar.length > 2) {
        axios.get('/api/autocompletar/', {
          params: {
            palabraabuscar: this.palabra_abuscar
          }
      ...
      if (this.slug) {
        ...
        axios.get(url).then(function (response) {
          ...
          if (_this.div_mensajeslug === "Slug disponible") {
            ...
            _this.btn_deshabilitado = 0;
          } else {
            _this.div_class_slug = 'badge badge-danger';
            _this.btn_deshabilitado = 1;
          }
...
/***/ "./resources/js/admin/confirmareliminar.js":
/*!*************************************************!*\
  !*** ./resources/js/admin/confirmareliminar.js ***!
  \*************************************************/
/*! no static exports found */
...
var confirmareliminar = new Vue({
  ...
  methods: {
    peticion_elimiar: function peticion_elimiar(id) {
      this.id = id;
...
if (document.getElementById('apicategoria')) {
  __webpack_require__(/*! ./admin/apicategoria */ "./resources/js/admin/apicategoria.js"); // JavaScript

}

if (document.getElementById('apiproducto')) {
  __webpack_require__(/*! ./admin/apiproducto */ "./resources/js/admin/apiproducto.js"); // JavaScript

}

if (document.getElementById('confirmareliminar')) {
  __webpack_require__(/*! ./admin/confirmareliminar */ "./resources/js/admin/confirmareliminar.js"); // JavaScript

}

if (document.getElementById('apiautocompletar')) {
  __webpack_require__(/*! ./admin/apiautocompletar */ "./resources/js/admin/apiautocompletar.js"); // JavaScript
...
module.exports = __webpack_require__(/*! c:\xampp\htdocs\shop\resources\js\app_admin.js */"./resources/js/app_admin.js");
